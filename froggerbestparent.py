...
fps = 30  # Simulation speed, can be changed if needed
...
class Population:
    ...
    # Selects the parent frog with the highest fitness from the previous generation
    def selectParent(self):
        ...
        for frog in frogs: 
            if frog.fitness > max: 
                max = frog.fitness
                bestFrog = frog.brain.directions
        return bestFrog
...
message_display(f'Completion Time: {endTime - startTime:0.4f} seconds')
pygame.quit()
quit()
